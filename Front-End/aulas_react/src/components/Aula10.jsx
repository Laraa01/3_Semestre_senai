...
const Aula10 = () => {
    ...
    //o useEffect com [] vazia, significa que o efeito deve ser executado apenas quando a página é carregada
    useEffect( () => {
    ...
    function botaoContador () {
        ...
        localStorage.setItem('valoContador', JSON.stringify(novoContador))
